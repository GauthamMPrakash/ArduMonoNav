...
<p align="center">
  <a href="https://www.python.org/downloads/release/python-31212/">
    <img src="https://img.shields.io/badge/Python-3.9--3.12-3776AB?logo=python&logoColor=white" alt="Python 3.9-3.12" />
  </a>
  &nbsp;&nbsp;
  <a href="https://opencv.org/">
    <img src="https://img.shields.io/badge/OpenCV-4.11-5C3EE8?logo=opencv&logoColor=white" alt="OpenCV 4.11" />
  </a>
  &nbsp;&nbsp;
  <a href="https://github.com/isl-org/Open3D/releases/tag/v0.19.0">
    <img src="https://img.shields.io/badge/Open3D-0.19-3E6FB0?logo=Open3D&logoColor=white" alt="Open3D 0.19" />
  </a>
  &nbsp;&nbsp;
  ...
  &nbsp;&nbsp;
  <a href="https://github.com/DepthAnything/Depth-Anything-V2/tree/main/metric_depth">
    <img src="https://img.shields.io/badge/Depth%20Anything%20V2-Metric-111827?logo=github&logoColor=white" alt="Depth Anything V2 Metric" />
  </a>
</p>
...
<p align="center">
<img src="utils/assets/avoidance.png" height="300px" alt="Obstacle Avoidance"/>
</p>
...
<p align="center">
  <img src="utils/assets/demo_vid.gif" alt="3D Reconstruction using Open3D and Monocular Depth" />
</p>
...
For this one to work, you need to scale down the reconstruction sizes by a factor. This is probably due to incorrect handling of transformed frame or a quirk of DepthAnythingV2 when it works on fisheye. Another possibility is that fisheye calibration has to be used instead of the pinhole model currently used in [utils.py](utils/utils.py). The original MonoNav used a simpler pinhole model with the fisheye lens but it has worked there.
We have implemented a scaling code in utils.py to scale down the image because of the zooming effect caused by heavy cropping after undistortion. To enable this, set `depth_scale_scaling = True` in line 29 of utils.py. But even this might still be overestimating. A quick fix is to set `depth_scale` to about 3000. This number has been found empirically to be about 3x the average zoom factor on either axes after the cropping.
...
<img src="utils/assets/reconstruction.gif" height="250px" alt="3D Reconstruction using Open3D and Monocular Depth"/>
